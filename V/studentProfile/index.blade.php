                            ...
                            <div class="col-md-2 text-center">
                                ...
                                <div class="profile-userpic">
                                    ...
                                    <img src="{{URL::to('/')}}/public/uploads/user/{{$studentInfoData->photo}}" class="text-center img-responsive pic-bordered border-default recruit-profile-photo-full"
                                         alt="{{ $studentInfoData->student_name }}" style="width: 250px;height: 160px;" />
                                    @else 
                                ...
                                <div class="profile-usertitle">
                                    <div class="text-center">
                                        <b>{{ $studentInfoData->student_name}}</b>
                                    </div>
                                </div>
                            </div>
                            <!-- END::User Image -->
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-bordered">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-right">{{ ((!empty($studentInfoData->weight)) && ($studentInfoData->weight != '0.00')) ? $studentInfoData->weight . ' ' .__('label.KG') : ''}}</td>
                                                </tr>
                                                <tr>
                                                    <?php
                                                    ...
                                                    <td class = "fit bold info">@lang('label.MARITIAL_STATUS')</td>
                                                    <td> {{ $maritalStatus }} </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td colspan="3">{{ !empty($studentInfoData->phone) ? $studentInfoData->phone: ''}}</td>
                                                </tr>
                                                <tr>
                                                    <td class="fit bold info">@lang('label.EMAIL')</td>
                                                    <td colspan="3">{{ !empty($studentInfoData->email) ? $studentInfoData->email: ''}}</td> 
                                                </tr>
                                ...
                                <div class="portlet portlet-sortable box green-color-style">
                                    ...
                                    <div class="portlet-body" style="padding: 8px !important">
                                        <div class="table-responsive">
                                            <table class="table table-bordered">
                                                <tr>
                                                    <td class="fit bold info">@lang('label.FATHERS_NAME')</td>
                                                    <td>{{ !empty($studentInfoData->father_name) ? $studentInfoData->father_name: __("label.N_A")}}</td>
                                                    <td class="fit bold info">@lang('label.MOTHERS_NAME')</td>
                                                    <td> {{ !empty($studentInfoData->mother_name) ? $studentInfoData->mother_name: __("label.N_A")}}</td>
                                                </tr>
                                                <tr>
                                                    <td class="fit bold info">@lang('label.OCCUPATION')</td>
                                                    <td>{{ !empty($studentInfoData->father_occupation) ? $studentInfoData->father_occupation: __("label.N_A")}}</td>
                                                    <td class="fit bold info">@lang('label.OCCUPATION')</td>
                                                    <td> {{ !empty($studentInfoData->mother_occupation) ? $studentInfoData->mother_occupation: __("label.N_A")}}</td>
                                                </tr>
                                                <tr>
                                                    <td class="fit bold info">@lang('label.WORK_ADDRESS')</td>
                                                    <td>{{ !empty($studentInfoData->father_address) ? $studentInfoData->father_address: __("label.N_A")}}</td>
                                                    <td class="fit bold info">@lang('label.WORK_ADDRESS')</td>
                                                    <td>{{ !empty($studentInfoData->mother_address) ? $studentInfoData->mother_address: __("label.N_A")}}</td>
                                                </tr>
                                            </table>
                                        </div>
                                    </div>
                                    ...
                                    <div class="portlet-body" style="padding: 8px !important">
                                        <div class="table-responsive">
                                            <table class="table table-bordered">
                                                ...
                                                <tr>
                                                    <td class = "fit bold info">@lang('label.DATE_OF_MARRIAGE')</td>
                                                    <td colspan="3">{{ isset($studentInfoData->date_of_marriage) ? Helper::formatDate($studentInfoData->date_of_marriage): ''}}</td>
                                                    @endif
                                                </tr>
                                                @if($studentInfoData->marital_status == '1')
                                                <tr>
                                                    <td class = "fit bold info">@lang('label.SPOUSE_NAME')</td>
                                                    <td>{{!empty($studentInfoData->spouse_name) ? $studentInfoData->spouse_name: ''}}</td>
                                                    <td class = "fit bold info">@lang('label.OCCUPATION')</td>
                                                    <td>{{!empty($studentInfoData->spouse_occupation) ? $studentInfoData->spouse_occupation: ''}}</td>
                                                </tr>
                                                <tr>
                                                    <td class = "fit bold info">@lang('label.WORK_ADDRESS')</td>
                                                    <td colspan="3">{{!empty($studentInfoData->spouse_work_address) ? $studentInfoData->spouse_work_address: __('label.N_A')}}</td>
                                                </tr>
                                                @else
                                                <tr>
                                ...
                                <div class="portlet portlet-sortable box green-color-style">
                                    ...
                                    <div class="portlet-body" style="padding: 8px !important">
                                        <div class="table-responsive">
                                            <table class="table table-bordered">
                                                <tr>
                                                    <th class="fit bold info">@lang('label.SERIAL')</th>
                                                    <td class="fit bold info">@lang('label.NAME')</td>
                                                    <td class="fit bold info">@lang('label.RELATION')</td>
                                                    <td class="fit bold info">@lang('label.AGE')</td>
                                                    <td class="fit bold info">@lang('label.OCCUPATION')</td>
                                                    <td class="fit bold info">@lang('label.WORK_ADDRESS')</td>
                                                </tr>
                                                <?php
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{ !empty($brotherSisterInfo['name']) ? $brotherSisterInfo['name']: ''}}</td>
                                                    <td> {{ !empty($brotherSisterInfo['relation']) ? $brotherSisterInfo['relation']: ''}}</td>
                                                    <td class="vcenter text-center">{{ !empty($brotherSisterInfo['age']) ? $brotherSisterInfo['age']: ''}}</td>
                                                    <td> {{ !empty($brotherSisterInfo['occupation']) ? $brotherSisterInfo['occupation']: ''}}</td>
                                                    <td>{{ !empty($brotherSisterInfo['address']) ? $brotherSisterInfo['address']: ''}}</td>
                                                </tr>
                                                <?php $bSlShow++; ?>
                                                @endforeach
                                                @else
                                ...
                                <div class="portlet portlet-sortable box green-color-style">
                                    ...
                                    <div class="portlet-body" style="padding: 8px !important">
                                        <div class="table-responsive">
                                            <table class="table table-bordered">
                                                <tr>
                                                    <th scope="col" class="fit bold info">@lang('label.SERIAL')</th>
                                                    <td class="fit bold info">@lang('label.INSTITUTE_NAME')</td>
                                                    <td class="fit bold info">@lang('label.EXAMINATION')</td>
                                                    <td class="fit bold info">@lang('label.RESULT')</td>
                                                    <td class="fit bold info">@lang('label.YEAR')</td>
                                                </tr>
                                                <?php
                                                $cSlShow = 1;
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{ !empty($civilEducationInfo['institute_name']) ? $civilEducationInfo['institute_name']: ''}}</td>
                                                    <td> {{ !empty($civilEducationInfo['examination']) ? $civilEducationInfo['examination']: ''}}</td>
                                                    <td class="vcenter text-center">{{ !empty($civilEducationInfo['result']) ? $civilEducationInfo['result']: ''}}</td>
                                                    <td class="vcenter text-center"> {{ !empty($civilEducationInfo['year']) ? $civilEducationInfo['year']: ''}}</td>
                                                </tr>
                                                <?php
                                                $cSlShow++;
                                                ?>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-bordered">
                                                <tr>
                                                    <th class="fit bold info">@lang('label.SERIAL')</th>
                                                    <td class="fit bold info">@lang('label.UNIT')</td>
                                                    <td class="fit bold info">@lang('label.APPOINTMENT')</td>
                                                    <td class="fit bold info">@lang('label.YEAR')</td>
                                                </tr>
                                                <?php
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{ !empty($serviceRecordInfo['unit']) ? $unitList[$serviceRecordInfo['unit']]: ''}}</td>
                                                    <td>{{ !empty($serviceRecordInfo['appointment']) ? $appointmentList[$serviceRecordInfo['appointment']]: ''}}</td>
                                                    <td class="vcenter text-center">{{ !empty($serviceRecordInfo['year']) ? $serviceRecordInfo['year']: ''}}</td>
                                    ...
                                    <div class="portlet-body" style="padding: 8px !important">
                                        <div class="table-responsive">
                                            <table class="table table-bordered">
                                                <tr>
                                                    <th scope="col" class="fit bold info">@lang('label.SERIAL')</th>
                                                    <td class="fit bold info">@lang('label.AWARD')</td>
                                                    <td class="fit bold info">@lang('label.REASON')</td>
                                                    <td class="fit bold info">@lang('label.YEAR')</td>
                                                </tr>
                                                <?php
                                                $aSlShow = 1;
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{ !empty($awardRecordInfo['award']) ? $awardRecordInfo['award']: ''}}</td>
                                                    <td> {{ !empty($awardRecordInfo['reason']) ? $awardRecordInfo['reason']: ''}}</td>
                                                    <td class="vcenter text-center"> {{ !empty($awardRecordInfo['year']) ? $awardRecordInfo['year']: ''}}</td>
                                                </tr>
                                                <?php
                                                $aSlShow++;
                                                ?>
                                    ...
                                    <div class="portlet-body" style="padding: 8px !important">
                                        <div class="table-responsive">
                                            <table class="table table-bordered">
                                                <tr>
                                                    <th scope="col" class="fit bold info">@lang('label.SERIAL')</th>
                                                    <td class="fit bold info">@lang('label.PUNISHMENT')</td>
                                                    <td class="fit bold info">@lang('label.REASON')</td>
                                                    <td class="fit bold info">@lang('label.YEAR')</td>
                                                </tr>
                                                <?php
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{ !empty($punishmentRecordInfo['punishment']) ? $punishmentRecordInfo['punishment']: ''}}</td>
                                                    <td> {{ !empty($punishmentRecordInfo['reason']) ? $punishmentRecordInfo['reason']: ''}}</td>
                                                    <td class="vcenter text-center"> {{ !empty($punishmentRecordInfo['year']) ? $punishmentRecordInfo['year']: ''}}</td>
                                                </tr>
                                                <?php
                                                $pSlShow++;
                                                ?>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-bordered">
                                                <tr>
                                                    ...
                                                    <td class="fit bold info">@lang('label.COURSE')</td>
                                                    <td class="fit bold info">@lang('label.INSTITUTE_NAME')</td>
                                                    <td class="fit bold info">@lang('label.GRADING')</td>
                                                    <td class="fit bold info">@lang('label.YEAR')</td>
                                                </tr>
                                                <?php
                                                $dSlShow = 1;
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{ !empty($defenceRelativeInfo['course']) ? $courseList[$defenceRelativeInfo['course']]: ''}}</td>
                                                    <td> {{ !empty($defenceRelativeInfo['institute']) ? $defenceRelativeInfo['institute']: ''}}</td>
                                                    <td> {{ !empty($defenceRelativeInfo['grading']) ? $defenceRelativeInfo['grading']: ''}}</td>
                                                    <td class="vcenter text-center"> {{ !empty($defenceRelativeInfo['year']) ? $defenceRelativeInfo['year']: ''}}</td>
                                                </tr>
                                                <?php
                                                $dSlShow++;
                                                ?>
                                    ...
                                    <div class="portlet-body" style="padding: 8px !important">
                                        <div class="table-responsive">
                                            <table class="table table-bordered">
                                                <tr>
                                                    <th scope="col" class="fit bold info">@lang('label.SERIAL')</th>
                                                    <td class="fit bold info">@lang('label.EXERCISE')</td>
                                                    <td class="fit bold info">@lang('label.YEAR')</td>
                                                    <td class="fit bold info">@lang('label.PLACE')</td>
                                                </tr>
                                                <?php
                                                $wSlShow = 1;
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{ !empty($winterTrainingInfo['exercise']) ? $winterTrainingInfo['exercise']: ''}}</td>
                                                    <td class="vcenter text-center"> {{ !empty($winterTrainingInfo['year']) ? $winterTrainingInfo['year']: ''}}</td>
                                                    <td> {{ !empty($winterTrainingInfo['place']) ? $winterTrainingInfo['place']: ''}}</td>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="portlet portlet-sortable box green-color-style">
                                    <div class="portlet-title ui-sortable-handle">
                                        <div class="caption">
                                            <i class="fa fa fa-users green-color-style-color"></i>@lang('label.MEDICAL_DETAILS')
                                        </div>
                                    </div>
                                    <div class="portlet-body" style="padding: 8px !important">
                                        <div class="table-responsive">
                                            <table class="table table-bordered">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{ isset($studentMedicalDetails->date_of_birth) ? Helper::formatDate($studentMedicalDetails->date_of_birth): __("label.N_A")}}</td>
                                ...
                                <div class="portlet portlet-sortable box green-color-style">
                                    ...
                                    <div class="portlet-body" style="padding: 8px !important">
                                        <div class="table-responsive">
                                            <table class="table table-bordered">
                                                <tr>
                                                    <td class="fit bold info">@lang('label.VISITED_COUNTRIES')</td>
                                                    @php
                                                ...
                                                <tr>
                                                    <td class="fit bold info">@lang('label.SPECIAL_QUALITY')</td>
                                                    <td colspan="3">  {{ !empty($othersInfoData->special_quality) ? $othersInfoData->special_quality: __("label.N_A")}}</td>
                                                </tr>
                                                <tr>
                                                    <td class="fit bold info">@lang('label.SWIMMING')</td>
                                                    <td>{{ !empty($othersInfoData->swimming)?$swimmingList[$othersInfoData->swimming]:  __("label.N_A")}}</td>
                                                    <td class="fit bold info">@lang('label.PROFESSIONAL_COMPUTER')</td>
                                                    @if(!empty($othersInfoData->professional_computer) && $othersInfoData->professional_computer == '1')
                                                    <td>@lang('label.YES') </td>
                                                    @else
                                                    <td>@lang('label.NO') </td>
                                                    @endif
                                                </tr>
                                ...
                                <ul class = "ver-inline-menu tabbable margin-bottom-10">
                                    ...
                                    <li>
                                        <a data-toggle = "tab" href = "#tab_9">
                                            <i class="fa fa-user"></i></i> @lang('label.MEDICAL_DETAILS') </a>
                                    </li>
                                    <li>
                                                    ...
                                                    <table class="table table-bordered">
                                                        <thead>
                                                            <tr class="info">
                                                                ...
                                                                <th scope="col" class="vcenter text-center">@lang('label.NAME')<span class="text-danger"> *</span></th>
                                                                <th scope="col" class="vcenter text-center">@lang('label.RELATION')<span class="text-danger"> *</span></th>
                                                                <th scope="col" class="vcenter text-center">@lang('label.AGE')</th>
                                                                <th scope="col" class="vcenter text-center">@lang('label.OCCUPATION')</th>
                                                                <th scope="col" class="vcenter text-center">@lang('label.ADDRESS')</th>
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table table-bordered">
                                                        <thead>
                                                            <tr class="info">
                                                                <th scope="col" class="vcenter text-center">@lang('label.SERIAL')</th>
                                                                <th scope="col" class="vcenter text-center">@lang('label.INSTITUTE_NAME') <span class="text-danger"> *</span></th>
                                                                <th scope="col" class="vcenter text-center">@lang('label.EXAMINATION') <span class="text-danger"> *</span></th>
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                @if($cSl == 1)
                                                                <td class="vcenter text-center text-center">
                                                    ...
                                                    <table class="table table-bordered">
                                                        <thead>
                                                            <tr class="info">
                                                                ...
                                                                <th scope="col" class="vcenter text-center">@lang('label.UNIT') <span class="text-danger"> *</span></th>
                                                                <th scope="col" class="vcenter text-center">@lang('label.APPOINTMENT') <span class="text-danger"> *</span></th>
                                                                <th scope="col" class="vcenter text-center">@lang('label.YEAR') <span class="text-danger"> *</th>
                                                                <th scope="col" class="vcenter text-center"></th>
                                                            </tr> 
                                                        </thead>
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td class="vcenter text-center width-300">
                                                                ...
                                                                <td class="vcenter text-center width-100">
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table table-bordered">
                                                        <thead>
                                                            <tr class="info">
                                                                <th scope="col" class="vcenter text-center width-50">@lang('label.SERIAL')</th>
                                                                <th scope="col" class="vcenter text-center">@lang('label.AWARD') <span class="text-danger"> *</span></th>
                                                                <th scope="col" class="vcenter text-center">@lang('label.REASON') <span class="text-danger"> *</span></th>
                                                                <th scope="col" class="vcenter text-center">@lang('label.YEAR') <span class="text-danger"> *</th>
                                                                <th scope="col" class="vcenter text-center"></th>
                                                            </tr> 
                                                        </thead>
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td class="vcenter text-center width-250">
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table table-bordered">
                                                        <thead>
                                                            <tr class="info">
                                                                <th scope="col" class="vcenter text-center width-50">@lang('label.SERIAL')</th>
                                                                <th scope="col" class="vcenter text-center">@lang('label.PUNISHMENT') <span class="text-danger"> *</span></th>
                                                                <th scope="col" class="vcenter text-center">@lang('label.REASON') <span class="text-danger"> *</span></th>
                                                                <th scope="col" class="vcenter text-center">@lang('label.YEAR') <span class="text-danger"> *</th>
                                                                <th scope="col" class="vcenter text-center"></th>
                                                            </tr> 
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td class="vcenter text-center text-center width-50">
                                                                    @if($pSl == 1)
                                                    ...
                                                    <table class="table table-bordered">
                                                        <thead>
                                                            <tr class="info">
                                                                ...
                                                                <th scope="col" class="vcenter text-center width-50">@lang('label.SERIAL')</th>
                                                                <th scope="col" class="vcenter text-center">@lang('label.COURSE') <span class="text-danger"> *</span></th>
                                                                <th scope="col" class="vcenter text-center">@lang('label.INSTITUTE_NAME') <span class="text-danger"> *</span></th>
                                                                <th scope="col" class="vcenter text-center">@lang('label.GRADING') <span class="text-danger"> *</span></th>
                                                                <th scope="col" class="vcenter text-center">@lang('label.YEAR') <span class="text-danger"> *</th>
                                                                <th scope="col" class="vcenter text-center"></th>
                                                            </tr> 
                                                        </thead>
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td class="vcenter text-center width-200">
                                                    ...
                                                    <div class="table-responsive" id="winterTrainingRowAdd">
                                                        <table class="table table-bordered">
                                                            <thead>
                                                                <tr class="info">
                                                                    <th scope="col" class="vcenter text-center">@lang('label.SERIAL') </th>
                                                                    <th scope="col" class="vcenter text-center">@lang('label.EXERCISE') <span class="text-danger"> *</span></th>
                                                                    <th scope="col" class="vcenter text-center">@lang('label.YEAR') <span class="text-danger"> *</span></th>
                                                                    <th scope="col" class="vcenter text-center">@lang('label.PLACE')</th>
                                                                </tr>
                                                            </thead>
                                                            ...
                                                            <td class="vcenter text-center">
                                                                {!! Form::text('winter_training['.$wtVar.'][year]', !empty($studentWinterTrainingInfo['year'])?$studentWinterTrainingInfo['year']:null,  ['class' => 'form-control', 'id' => 'winterTraining['.$wtVar.'][year]']) !!}
                                                            </td>
                                                            <td class="vcenter text-center">
            ...
            $("#participatedNo").on('keyup', function () {
                ...
                for (var i = 1; i <= participatedNo; i++) {
                    $("#winterTrainingRow").append(
                            ...
                            '<td><input type="text" name="winter_training[' + i + '][exercise]" class="form-control" id="winterTraining[' + i + '][exercise]" /></td>' +
                            '<td><input type="text" name="winter_training[' + i + '][year]" class="form-control" id="winterTraining[' + i + '][year]" /></td>' +
                            '<td><input type="text" name="winter_training[' + i + '][place]" class="form-control" id="winterTraining[' + i + '][place]" /></td>' +
                            '</tr>'
                            );
                }
